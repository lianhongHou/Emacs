...
/* ./.libs/lt-gtags-cscope.c - temporary wrapper executable for .libs/gtags-cscope.exe
   Generated by libtool (GNU libtool) 2.4.2

   The gtags-cscope program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gtags-cscope.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gtags-cscope - temporary wrapper script for .libs/gtags-cscope.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The gtags-cscope program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gtags-cscope.exe:gtags-cscope:${LINENO}: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gtags-cscope.exe:gtags-cscope:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gtags-cscope.exe:gtags-cscope:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='gtags-cscope.exe'\n", f);
