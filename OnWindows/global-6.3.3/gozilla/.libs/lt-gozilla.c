...
/* ./.libs/lt-gozilla.c - temporary wrapper executable for .libs/gozilla.exe
   Generated by libtool (GNU libtool) 2.4.2

   The gozilla program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gozilla.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gozilla - temporary wrapper script for .libs/gozilla.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The gozilla program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gozilla.exe:gozilla:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gozilla.exe:gozilla:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gozilla.exe:gozilla:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
